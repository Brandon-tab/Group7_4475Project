...
as.data.frame(Credit_Average)

#count the number of different education level

Level_Count<-tapply(Transform$Education_Level, Transform$Education_Level, length)
as.data.frame(Level_Count)
...
as.data.frame(Open_to_buy_Average)
